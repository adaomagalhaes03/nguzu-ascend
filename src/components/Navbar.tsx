...
import { Menu, X, Phone, Moon, Sun, User } from 'lucide-react';
          ...
          <nav className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <button
                ...
                className="btn-hero-primary text-xs py-2 px-4"
              >
                Solicitar Proposta
              </button>
            </div>
              ...
              <div className="container mx-auto px-4 py-4 space-y-3">
                ...
                >
                  <button
                    ...
                    className="btn-hero-primary block text-center py-2 text-sm w-full"
                  >
                    Solicitar Proposta
                  </button>
                </motion.div>
